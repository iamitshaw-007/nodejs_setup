export const nodemonConfig = {
    ...
    "ignore": ["node_modules", "dist"],                    /* List of files or directories to ignore. */
    ...
    "legacyWatch": true,                                   /* Use polling to watch for file changes (useful in some networked environments). */
    "signal": "SIGHUP",                                    /* Signal to send to the process on restart. */
    "restartable": "rs",                                   /* Specify a key sequence that will restart the application. */
  
    /* Environment Variables */
    "env": {
      "NODE_ENV": "development",                           /* Set environment variables for the process. */
      "DEBUG": "app:*"                                     /* Enable debug logging for the app namespace. */
    },
  
    /* Events */
    "events": {
      "restart": "echo 'App restarted due to changes'",    /* Command to execute when the app restarts. */
    ...
    "runOnChangeOnly": false,                              /* Only restart the app if a watched file changes. */
    ...
    "configFile": "path/to/nodemon.json",                  /* Specify a custom path to the Nodemon config file. */
